...
>
> 最后更新：2026-09-04 ｜ 维护者：赵秦程（Orange1021）
> 上游项目：[loks666/get_jobs](https://github.com/loks666/get_jobs)（本项目为其深度改造版，历史已重写为单仓库）
>
> 🛠️ **要继续开发本项目？** 先读 [DEVELOPMENT_PLAYBOOK.md](DEVELOPMENT_PLAYBOOK.md)
> ——开发工作流、测试策略与带优先级的改进路线图都在那里。
> 🚀 **要部署运行？** 按 [AI_SETUP_GUIDE.md](AI_SETUP_GUIDE.md) 执行。
